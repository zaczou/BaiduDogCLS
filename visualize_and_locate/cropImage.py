...
#Crop test_img-01
#=============
test_src=os.path.join(Project_dir,"dataset/test-01/image")
test_crop=os.path.join(Project_dir,"dataset/test-01/crop_image")
...
#Crop test_img-02
#=============
test_src=os.path.join(Project_dir,"dataset/test-02/image")
test_crop=os.path.join(Project_dir,"dataset/test-02/crop_image")
test_files = [im for im in os.listdir(test_src)]
test_files.sort()
img_index = 0
for img in test_files:
